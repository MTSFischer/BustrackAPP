...
export function LoginScreen() {
  return (
    <div className="w-[390px] h-[852px] bg-gradient-to-t from-[#0C9B8A] to-white flex flex-col items-center py-10">
      <div className="flex flex-col items-center mb-8">
        <div className="relative w-20 h-20">
          <MapPin className="w-full h-full text-white" />
          <Bus className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 text-[#0C9B8A] w-10 h-10" />
        </div>
